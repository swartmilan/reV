...
class Gen:
    ...
    OUT_ATTRS = {'other': {'scale_factor': 1, 'units': 'unknown',
                 ...
                 # PVWattsV5
                 'ac': {'scale_factor': 1, 'units': 'W',
                        'dtype': 'float32', 'chunks': (None, 100),
                        'type': 'array'},
                 'tamb': {'scale_factor': 1, 'units': 'C',
                          'dtype': 'int16', 'chunks': (None, 100),
                          'type': 'array'},
                 'aoi': {'scale_factor': 1, 'units': 'degrees',
                         'dtype': 'float32', 'chunks': (None, 100),
                         'type': 'array'},
                 'dn': {'scale_factor': 1, 'units': 'W/m2',
                        'dtype': 'uint16', 'chunks': (None, 100),
                        'type': 'array'},
                 'dc': {'scale_factor': 1, 'units': 'W',
                        'dtype': 'float32', 'chunks': (None, 100),
                        'type': 'array'},
                 'df': {'scale_factor': 1, 'units': 'W/m2',
                        'dtype': 'uint16', 'chunks': (None, 100),
                        'type': 'array'},
                 'gh': {'scale_factor': 1, 'units': 'W/m2',
                        'dtype': 'uint16', 'chunks': (None, 100),
                        'type': 'array'},
                 'tcell': {'scale_factor': 1, 'units': 'C',
                           'dtype': 'float32', 'chunks': (None, 100),
                           'type': 'array'},
                 'sunup': {'scale_factor': 1, 'units': 'unitless',
                           'dtype': 'int8', 'chunks': (None, 100),
                           'type': 'array'},
                 'tpoa': {'scale_factor': 1, 'units': 'W/m2',
                          'dtype': 'float32', 'chunks': (None, 100),
                          'type': 'array'},
                 'wspd': {'scale_factor': 1, 'units': 'm/s',
                          'dtype': 'float32', 'chunks': (None, 100),
                          'type': 'array'},
                 ...
                 'dni_costh': {'scale_factor': 1, 'units': 'W/m2',
                               'dtype': 'float32', 'chunks': (None, 100),
                               'type': 'array'},
                 'annual_gross_energy': {'scale_factor': 1, 'units': 'kWt-hr',
                                         'dtype': 'float32',
                                         'chunks': None,
                                         'type': 'scalar'},
                 # 'annual_energy': {'scale_factor': 1, 'units': 'kWt-hr',
                 # 'dtype': 'float32',
                 # 'chunks': None,
                 # 'type': 'scalar'},
                 'e_ch_tes': {'scale_factor': 1, 'units': 'MWht',
                              'dtype': 'float32', 'chunks': (None, 100),
                              'type': 'array'},
                 'm_dot_htf_heat_sink': {'scale_factor': 1, 'units': 'kg/s',
                                         'dtype': 'float32',
                                         'chunks': (None, 100),
                                         'type': 'array'},
                 'm_dot_tes_ch': {'scale_factor': 1, 'units': 'kg/s',
                                  'dtype': 'float32', 'chunks': (None, 100),
                                  'type': 'array'},
                 'm_dot_tes_dc': {'scale_factor': 1, 'units': 'kg/s',
                                  'dtype': 'float32', 'chunks': (None, 100),
                                  'type': 'array'},
                 'q_ch_tes': {'scale_factor': 1, 'units': 'MWt',
                              'dtype': 'float32', 'chunks': (None, 100),
                              'type': 'array'},
                 'T_heat_sink_in': {'scale_factor': 1, 'units': 'C',
                                    'dtype': 'float32', 'chunks': (None, 100),
                                    'type': 'array'},
                 'T_heat_sink_out': {'scale_factor': 1, 'units': 'C',
                                     'dtype': 'float32', 'chunks': (None, 100),
                                     'type': 'array'},
                 'T_tes_cold': {'scale_factor': 1, 'units': 'C',
                                'dtype': 'float32', 'chunks': (None, 100),
                                'type': 'array'},
                 'T_tes_hot': {'scale_factor': 1, 'units': 'C',
                               'dtype': 'float32', 'chunks': (None, 100),
                               'type': 'array'},
                 'W_dot_pc_pump': {'scale_factor': 1, 'units': 'MWe',
                                   'dtype': 'float32', 'chunks': (None, 100),
                                   'type': 'array'},
                 }
